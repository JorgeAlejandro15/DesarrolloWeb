...
SECRET_KEY = 'django-insecure-slgv^)(4y6$*!cd$0602i-&l8ti5#*%ml-zfwqa)hj4m_w&1yv'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join('cafeteria\cafeteria_app','templates') 
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [ 
                ...
                'cafeteria_app.context_processor.total_carrito', 
            ],
        },
    },
]
